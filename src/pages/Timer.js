...
export default class Timer extends React.Component {
  ...
  start = async () => {
    ...
    if( Notification.permission === 'default' ) { // la primera vez tenemos default
      await Notification.requestPermission() // preguntar
    }
    ...
    if( Notification.permission !== 'granted' ) { // solo por las dudas
      return;
    }
  ...
  showNotification = async () => {
    // Esto solo funciona en produccion
